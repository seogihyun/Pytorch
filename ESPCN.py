...
cudnn.benchmark = True  # 내장된 cudnn 자동 튜너를 활성화하여 하드웨어에 맞게 사용할 최상의 알고리즘을 찾음
...
train_dataloader = torch.utils.data.DataLoader(train_dataset,
                                               ...
                                               shuffle=True,
                                               pin_memory=True,  # DataLoader는 Tensor를 CUDA 고정 메모리에 올림
                                               num_workers=int(args.workers)) # 데이터 로딩에 사용하는 subprocess 개수 (멀티 프로세싱)
